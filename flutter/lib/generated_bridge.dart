...
abstract class Rustdesk {
  ...
  FlutterRustBridgeTaskConstMeta get kMainGetServerProfilesConstMeta;

  Future<String> mainAddServerProfile(
      {required String name,
      required String idServer,
      required String key,
      dynamic hint});

  FlutterRustBridgeTaskConstMeta get kMainAddServerProfileConstMeta;

  Future<String> mainUpdateServerProfile(
      {required String id,
      required String name,
      required String idServer,
      required String key,
  ...
  FlutterRustBridgeTaskConstMeta get kMainUpdateServerProfileConstMeta;

  Future<String> mainDeleteServerProfile({required String id, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kMainDeleteServerProfileConstMeta;

  Future<String> mainSwitchServerProfile({required String id, dynamic hint});

  FlutterRustBridgeTaskConstMeta get kMainSwitchServerProfileConstMeta;

  Future<String> mainRecoverServerProfiles({dynamic hint});

  FlutterRustBridgeTaskConstMeta get kMainRecoverServerProfilesConstMeta;
...
class RustdeskImpl implements Rustdesk {
  ...
  Future<String> mainGetServerProfiles({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_main_get_server_profiles(port_),
      parseSuccessData: _wire2api_String,
      constMeta: kMainGetServerProfilesConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kMainGetServerProfilesConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "main_get_server_profiles",
        argNames: [],
      );
  ...
  Future<String> mainAddServerProfile(
    ...
    var arg1 = _platform.api2wire_String(idServer);
    var arg2 = _platform.api2wire_String(key);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_main_add_server_profile(port_, arg0, arg1, arg2),
      parseSuccessData: _wire2api_String,
      constMeta: kMainAddServerProfileConstMeta,
      argValues: [name, idServer, key],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kMainAddServerProfileConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "main_add_server_profile",
        argNames: ["name", "idServer", "key"],
      );
  ...
  Future<String> mainUpdateServerProfile(
    ...
    var arg0 = _platform.api2wire_String(id);
    var arg1 = _platform.api2wire_String(name);
    var arg2 = _platform.api2wire_String(idServer);
    var arg3 = _platform.api2wire_String(key);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_main_update_server_profile(port_, arg0, arg1, arg2, arg3),
      parseSuccessData: _wire2api_String,
      constMeta: kMainUpdateServerProfileConstMeta,
      argValues: [id, name, idServer, key],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kMainUpdateServerProfileConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "main_update_server_profile",
        argNames: ["id", "name", "idServer", "key"],
      );
  ...
  Future<String> mainDeleteServerProfile({required String id, dynamic hint}) {
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_main_delete_server_profile(port_, arg0),
      parseSuccessData: _wire2api_String,
      constMeta: kMainDeleteServerProfileConstMeta,
      argValues: [id],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kMainDeleteServerProfileConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "main_delete_server_profile",
        argNames: ["id"],
      );
  ...
  Future<String> mainSwitchServerProfile({required String id, dynamic hint}) {
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_main_switch_server_profile(port_, arg0),
      parseSuccessData: _wire2api_String,
      constMeta: kMainSwitchServerProfileConstMeta,
      argValues: [id],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kMainSwitchServerProfileConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "main_switch_server_profile",
        argNames: ["id"],
      );
  ...
  Future<String> mainRecoverServerProfiles({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_main_recover_server_profiles(port_),
      parseSuccessData: _wire2api_String,
      constMeta: kMainRecoverServerProfilesConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kMainRecoverServerProfilesConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "main_recover_server_profiles",
        argNames: [],
      );
...
class RustdeskWire implements FlutterRustBridgeWireBase {
  ...
  void wire_main_get_server_profiles(
    int port_,
  ) {
    return _wire_main_get_server_profiles(
      port_,
    );
  }

  late final _wire_main_get_server_profilesPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_main_get_server_profiles');
  late final _wire_main_get_server_profiles =
      _wire_main_get_server_profilesPtr.asFunction<void Function(int)>();

  void wire_main_add_server_profile(
    int port_,
    ffi.Pointer<wire_uint_8_list> name,
    ffi.Pointer<wire_uint_8_list> id_server,
    ffi.Pointer<wire_uint_8_list> key,
  ) {
    return _wire_main_add_server_profile(
      port_,
      name,
      id_server,
      key,
  ...
  late final _wire_main_add_server_profilePtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64,
              ffi.Pointer<wire_uint_8_list>,
              ffi.Pointer<wire_uint_8_list>,
              ffi.Pointer<wire_uint_8_list>)>>('wire_main_add_server_profile');
  late final _wire_main_add_server_profile =
      _wire_main_add_server_profilePtr.asFunction<
          void Function(int, ffi.Pointer<wire_uint_8_list>,
              ffi.Pointer<wire_uint_8_list>, ffi.Pointer<wire_uint_8_list>)>();

  void wire_main_update_server_profile(
    int port_,
    ffi.Pointer<wire_uint_8_list> id,
    ffi.Pointer<wire_uint_8_list> name,
    ffi.Pointer<wire_uint_8_list> id_server,
    ...
    return _wire_main_update_server_profile(
      port_,
      id,
      name,
      id_server,
  ...
  late final _wire_main_update_server_profilePtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(
                  ffi.Int64,
                  ffi.Pointer<wire_uint_8_list>,
                  ...
                  ffi.Pointer<wire_uint_8_list>,
                  ffi.Pointer<wire_uint_8_list>)>>(
      'wire_main_update_server_profile');
  late final _wire_main_update_server_profile =
      _wire_main_update_server_profilePtr.asFunction<
          void Function(
              int,
              ffi.Pointer<wire_uint_8_list>,
              ffi.Pointer<wire_uint_8_list>,
  ...
  void wire_main_delete_server_profile(
    int port_,
    ffi.Pointer<wire_uint_8_list> id,
  ) {
    return _wire_main_delete_server_profile(
      port_,
      id,
    );
  }

  late final _wire_main_delete_server_profilePtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>(
      'wire_main_delete_server_profile');
  late final _wire_main_delete_server_profile =
      _wire_main_delete_server_profilePtr
          .asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>)>();

  void wire_main_switch_server_profile(
    int port_,
    ffi.Pointer<wire_uint_8_list> id,
  ) {
    return _wire_main_switch_server_profile(
      port_,
      id,
    );
  }

  late final _wire_main_switch_server_profilePtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>(
      'wire_main_switch_server_profile');
  late final _wire_main_switch_server_profile =
      _wire_main_switch_server_profilePtr
          .asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>)>();

  void wire_main_recover_server_profiles(
    int port_,
  ) {
    return _wire_main_recover_server_profiles(
      port_,
    );
  }

  late final _wire_main_recover_server_profilesPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_main_recover_server_profiles');
  late final _wire_main_recover_server_profiles =
      _wire_main_recover_server_profilesPtr.asFunction<void Function(int)>();
