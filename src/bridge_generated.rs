...
fn wire_main_get_server_profiles_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_get_server_profiles",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(main_get_server_profiles()),
    )
}
fn wire_main_add_server_profile_impl(
    port_: MessagePort,
    name: impl Wire2Api<String> + UnwindSafe,
    id_server: impl Wire2Api<String> + UnwindSafe,
    key: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_add_server_profile",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_name = name.wire2api();
            let api_id_server = id_server.wire2api();
            let api_key = key.wire2api();
            move |task_callback| Ok(main_add_server_profile(api_name, api_id_server, api_key))
        },
    )
}
fn wire_main_update_server_profile_impl(
    port_: MessagePort,
    id: impl Wire2Api<String> + UnwindSafe,
    name: impl Wire2Api<String> + UnwindSafe,
    id_server: impl Wire2Api<String> + UnwindSafe,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_update_server_profile",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
...
fn wire_main_delete_server_profile_impl(
    port_: MessagePort,
    id: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_delete_server_profile",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_id = id.wire2api();
            move |task_callback| Ok(main_delete_server_profile(api_id))
        },
    )
}
fn wire_main_switch_server_profile_impl(
    port_: MessagePort,
    id: impl Wire2Api<String> + UnwindSafe,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_switch_server_profile",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || {
            let api_id = id.wire2api();
            move |task_callback| Ok(main_switch_server_profile(api_id))
        },
    )
}
fn wire_main_recover_server_profiles_impl(port_: MessagePort) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, String>(
        WrapInfo {
            debug_name: "main_recover_server_profiles",
            port: Some(port_),
            mode: FfiCallMode::Normal,
        },
        move || move |task_callback| Ok(main_recover_server_profiles()),
    )
}
