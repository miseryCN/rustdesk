...
#[no_mangle]
pub extern "C" fn wire_main_get_server_profiles(port_: i64) {
    wire_main_get_server_profiles_impl(port_)
}

#[no_mangle]
pub extern "C" fn wire_main_add_server_profile(
    port_: i64,
    name: *mut wire_uint_8_list,
    id_server: *mut wire_uint_8_list,
    key: *mut wire_uint_8_list,
) {
    wire_main_add_server_profile_impl(port_, name, id_server, key)
}

#[no_mangle]
pub extern "C" fn wire_main_update_server_profile(
    port_: i64,
    id: *mut wire_uint_8_list,
    name: *mut wire_uint_8_list,
    id_server: *mut wire_uint_8_list,
    ...
    wire_main_update_server_profile_impl(port_, id, name, id_server, key)
}

#[no_mangle]
pub extern "C" fn wire_main_delete_server_profile(port_: i64, id: *mut wire_uint_8_list) {
    wire_main_delete_server_profile_impl(port_, id)
}

#[no_mangle]
pub extern "C" fn wire_main_switch_server_profile(port_: i64, id: *mut wire_uint_8_list) {
    wire_main_switch_server_profile_impl(port_, id)
}

#[no_mangle]
pub extern "C" fn wire_main_recover_server_profiles(port_: i64) {
    wire_main_recover_server_profiles_impl(port_)
}
